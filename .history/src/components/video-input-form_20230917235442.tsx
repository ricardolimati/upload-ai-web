...
export function VideoInputForm(){
  ...
  return(
    ...
    <label 
    htmlFor="video"
    className="reborder flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5"
    >
     {previewURL ? (
